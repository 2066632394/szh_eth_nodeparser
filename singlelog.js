...
*/
	...
	var contractConfig = require('./config/contract_trade.js');
	// 获取配置合约地址集合	
			...
			var temp = function(cb){
				connection.query("insert into trade_matches (id,active_id,passive_id,price,amount,matchtime,addtime,active_owner) values (?,?,?,?,?,?,?,?) ", sql_params, function (tErr, rows, fields) {
				    ...
				    cost = (cprice*amount)/100000000/100000000;
		                    console.log('row legth : '+rows2.length+"----------------amount :"+amount+'mtfid :'+mtfId+'offerid : '+offerid+"wantedid : "+wantedid+'sprice :'+sprice+" bprice : "+bprice+" type : "+active_type+'cprice :'+cprice+'cost:'+cprice);
