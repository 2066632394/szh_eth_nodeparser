...
if (cluster.isMaster) {
    ...
    var DB = new Dbobject(dbConfig.pooldb_bill);
    DB.createPool();
    ...
    var contractConfig = require('./config/contract_bill.js');
    // 获取配置合约地址集合	
