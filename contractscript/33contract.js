...
function BpContract(tx, receipt) {
	...
	this.insertPlaceOrders = function() {
		...
		console.log("contract", tx.to, "placeorder");
	...
	this.insertCancelOrders = function() {
		...
		console.log("contract", tx.to, "cancelorder");
	...
	this.insertMatchOrders = function() {
		...
		console.log("contract", tx.to, "matchorder");
	...
	this.insertSendCoins = function() {
		...
		console.log("contract", tx.to, "sendcoin");
	...
	this.run = function() {
		var tx = this.tx;
		var receipt = this.receipt; 
		if (typeof receipt["logs"] == "undefined" || receipt["logs"].length == 0 || typeof receipt["logs"][0].event == "undefined" || receipt["logs"][0].event == "Error"){
			return null;
		}
